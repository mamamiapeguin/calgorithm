...
static void destroy_left(BisTree *tree, BiTreeNode *node) {
    ...
    /* Do no tallow destruction of an empty tree. */
    ...
    if (*position != NULL) {
        ...
        if (tree->destroy != NULL) {
            ...
            /* TODO 指向结构体的指针(*position)使用->访问结构体成员, 结构体(**position)使用.访问结构体成员. (*position)->data等效(**position).data */
            /* TODO BitreeNode的data指向一个AvlNode */
        ...
        *position = NULL;
        ...
        /* Adjust the size of the tree to account for the destoryed node. */
        tree->size--;
    }
    return;
}
...
static void destroy_right(BisTree *tree, BiTreeNode *node) {
    ...
    if (*position != NULL) {
        ...
        if (tree->destroy != NULL) {
            /* Call a user-defined function to free dynamicaaly allocated data. */
            tree->destroy(((AvlNode *) (*position)->data)->data);
        }
        ...
        *position = NULL;
        ...
        /* Adjust the size of the tree ot account for the destroyed node. */
        tree->size--;
    }
    return;
}
